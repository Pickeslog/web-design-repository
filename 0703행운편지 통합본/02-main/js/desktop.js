  ...
  <li>파티 전 케이크 픽업 담당 정하기</li>
        ...
        function getFilteredLettersWithIndex() {
            ...
            return letters
                ...
                .filter(({ letter }) => activeLetterFilter !== 'favorite' || letter.favorite);
        }
        ...
        function renderLetters() {
            ...
            if (dtZone) dtZone.innerHTML = `<p>${summaryText}</p>`;
            renderLetterInboxPage();
        }
        ...
        function submitLetter(viewType) {
            ...
            // 성공 알림
            clovToast(`${emoji} 행운편지가 성공적으로 보내졌습니다!`, 'success');
...
/* ══════════════════════ END V5 BANNER ENGINE ══════════════════════ */
        ...
        function submitLetter(viewType) {
            ...
            if (!to || !from || !content) {
                clovAlert('받는 사람, 보내는 사람, 내용을 모두 입력해주세요!', { icon: '✏️', type: 'warn' });
                return;
            }

            // 여기서 실제로는 groupsData나 letters 배열에 저장하는 로직이 들어갑니다.
            // 일단 성공 알림 후 모달 닫기
            clovToast('편지가 성공적으로 작성되었습니다! 💌', 'success');
            closeModal(prefix + '-letter-modal');
        }
