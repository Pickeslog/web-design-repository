...
.clov-hdr-dropdown li:hover .gear-icon { animation: clovGearSpin .8s ease; }
@keyframes clovGearSpin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
`;
  ...
  function renderMain(cfg) {
    ...
    var dropdown = cfg.dropdownItems || [
      ...
      { label: ICON_SETTINGS + ' 사용자 설정',    onclick: "openProfileModal();document.getElementById('clov-hdr-drop').classList.remove('open')" },
