...
| 4 | [`../api-spec/05-db-unified-final.md`](../api-spec/05-db-unified-final.md) | **DB 스키마**(24테이블 DDL) |
...
- **안전망**: `main` 직접 커밋 금지(무조건 PR) · CI(lint/build) · 계약 변경은 **누구나, 근거를 남기고**.
  → 2026-08-13 프로젝트 기간 종료 이후 각자 동등한 권한으로 개발한다. 머지도 본인이 한다.
