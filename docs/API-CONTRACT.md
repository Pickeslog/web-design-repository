...
> **속도 감각** — 시작 1,000 + 하루 최대 3,000. 가장 싼 코스튬 900G는 첫날 바로 살 수 있고, **판매 중인 카탈로그(52,000 실측)는 약 17일**이다. **구매 → 장착 → 마스코트 변경 루프를 하루 안에 여러 번 완주**시키는 값이다.
>
> 개정 전 상한 500으로는 같은 카탈로그가 **약 68일**이라 데모에서 상점이 사실상 잠겨 있었다.
>
> ### ⚠️ 일수는 하루에 24 → 12 → 17로 움직였다 — 상한은 한 번도 안 건드렸다
>
